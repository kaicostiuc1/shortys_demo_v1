...
// Derived: average ~3 min per party → estimated parties ahead
...
function Hero() {
  return (
    ...
    >
      ...
      >
        {/* Subtle grid texture to suggest a diner booth */}
        <div
          style={{
            position: "absolute",
            inset: 0,
...
function DinerStories() {
  return (
    ...
    >
      ...
      {/* TikTok-style vertical video placeholders */}
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
            {/* // TODO: Replace with real hours pulled from Google Business Profile or Toast */}
            {[
